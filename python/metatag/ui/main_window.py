...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self) -> None:
        ...
        self._search_edit.setAccessibleName("Search tracks")
        self._search_edit.setToolTip("Search and filter tracks (Alt+S)")
        ...
        self._prev_button.setToolTip("Go to the previous track")
        ...
        self._next_button.setToolTip("Go to the next track")
