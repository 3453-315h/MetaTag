...
class AudioPlayer(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._play_button.setAccessibleName("Play/Pause")
        self._play_button.setToolTip("Play or pause the track")
        ...
        self._seek_slider.setAccessibleName("Track Position")
        self._seek_slider.setToolTip("Seek through the track")
